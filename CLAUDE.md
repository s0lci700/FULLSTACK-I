...
This project is indexed by GitNexus as **FULLSTACK-I** (3425 symbols, 5909 relationships, 214 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/FULLSTACK-I/context` | Codebase overview, check index freshness |
| `gitnexus://repo/FULLSTACK-I/clusters` | All functional areas |
| `gitnexus://repo/FULLSTACK-I/processes` | All execution flows |
| `gitnexus://repo/FULLSTACK-I/process/{name}` | Step-by-step execution trace |
